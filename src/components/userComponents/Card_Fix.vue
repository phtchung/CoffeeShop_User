        ...
        <v-dialog v-model="dialog" open-on-click width="400px" height="100px">
            <template v-slot:activator="{ on, attrs }">
                <div style="width: 10px;height: 10px">
                    <v-icon small color="#fa8c16" style="cursor: pointer; align-items: center font-size: 0.8375rem;line-height: 1; margin-top: 20px" class="fix_icon tch-order-card__icon" v-bind="attrs" v-on="on">
                        mdi-pencil
